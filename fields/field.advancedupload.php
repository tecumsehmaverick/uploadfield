<?php
	...
	-------------------------------------------------------------------------*/
		...
		public function displayPublishPanel(&$wrapper, $data = null, $error = null, $prefix = null, $postfix = null, $entry_id = null) {
			$this->_engine->Page->addScriptToHead(URL . '/extensions/advanceduploadfield/assets/jquery.js');
			$this->_engine->Page->addScriptToHead(URL . '/extensions/advanceduploadfield/assets/jquery-ui.js');
			$this->_engine->Page->addScriptToHead(URL . '/extensions/advanceduploadfield/assets/form.js');
		...
		// Output -------------------------------------------------------------
			...
			if ($error == null and !empty($data['file'])) {
				...
				$image->setAttribute('alt', "{{$handle}:{$entry_id}}");
